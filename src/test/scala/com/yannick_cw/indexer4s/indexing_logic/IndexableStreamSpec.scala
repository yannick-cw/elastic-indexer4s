...
import com.yannick_cw.indexer4s.indexing_logic.IndexLogic.{CreateIndex, DeleteOldIndices, IndexSource, SwitchAlias}
import com.yannick_cw.indexer4s.specs.Spec
